        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-primary-900 mb-6">
              ...
              <span className="gradient-text">AI & Human Insight</span>
            </h1>
            
            <p className="text-xl text-primary-600 mb-8">
              Led by Elie Schulman, we combine deep expertise in group facilitation and organizational 
              dynamics with cutting-edge AI solutions to help small businesses thrive in the digital age.
            </p>
            ...
            <div className="space-y-3 mb-8">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-primary-700">Virtual group learning tailored to your team's needs</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-accent flex-shrink-0" />
                <span className="text-primary-700">Expert facilitation that addresses the human side of AI</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-accent flex-shrink-0" />
                <span className="text-primary-700">Proven methodology from 18+ years of group dynamics expertise</span>
              </div>
            </div>
              ...
              >
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-primary-600">Years of Expertise</p>
                  </div>
                </div>
              </motion.div>
            </div>
